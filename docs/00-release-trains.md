...
| **2.0.0** on `rc/2.0.0` | Merge to `main` only when ready | i18n, multi-ruleset, KMP/CMP/iOS, **one-world DS + 3 themes** (Blue/Light/Neon), **accounts / shared stats** (never live remote scoring) |
